/*
	38. In this challenge, we provide you with a noun, a verb, an adjective and 
		...
		string, using the provided variables: 'myNoun', 'myAdjective', 'myVerb', 
		...
		final sentence has spaces between all the words. The result should be a 
		complete sentence.
*/
