/*
	113. We have defined a function named 'rangeOfNumbers()' with two parameters. 
		 ...
		 It should also work for cases where both 'startNum' and 'endNum' are the 
		 same.
*/
...
function rangeOfNumbers(startNum, endNum) {
	if (startNum === endNum) {
		...
		let myArr = rangeOfNumbers(startNum + 1, endNum);
